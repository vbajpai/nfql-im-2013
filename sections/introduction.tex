...
%\begin{figure}[ht]
  %\begin{minipage}[b]{0.5\linewidth}
    %\centering 
    %\includegraphics[scale=1]{nfql-pipeline}
    %\caption{Devebec’s Facade System}
    %\label{fig:devebec}
  %\end{minipage}	
  %\begin{minipage}[b]{0.5\linewidth}
    %\centering
    %\includegraphics[scale=1]{nfql-architecture}
    %\caption{MIT City Scanning Project}
    %\label{fig:mit}
  %\end{minipage}	
%\end{figure}
...
%\begin{figure}
        ...
        %\begin{subfigure}[b]{0.3\textwidth}
                %\centering
                %\includegraphics[width=\textwidth]{nfql-pipeline}
                %\caption{NFQL}
        ...
        %\begin{subfigure}[b]{0.3\textwidth}
                %\centering
                %\includegraphics[width=\textwidth]{nfql-architecture}
                %\caption{A tiger}
                %\label{fig:tiger}
        %\end{subfigure}
...
\begin{figure*}[!t]
  \subfloat{\includegraphics[width=0.7\textwidth]{nfql-pipeline}}
  \label{foo}
  \hfil
  \subfloat{\includegraphics[width=0.3\textwidth]{nfql-architecture}}
  \label{bar}
  \caption{NFQL Processing Pipeline \cite{vmarinov:2009} (left) and \texttt{nfql}
Architecture (right)}
  \label{fig:nfql-pipeline}
\end{figure*}
